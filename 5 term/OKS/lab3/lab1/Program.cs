...
namespace lab1
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            string portNamesPath = $"C:\\Users\\khodosevich\\matvey\\lab1\\Configuration\\PortPairConfig.csv";
        ...
        private static Process StartReader(string portName, int speed)
        {
            ...
            p.StartInfo.FileName = $"C:\\Users\\khodosevich\\matvey\\Reader\\bin\\Debug\\net7.0\\Reader.exe";
        ...
        private static Process StartWriter(string portName, int speed)
        {
            ...
            p.StartInfo.FileName = $"C:\\Users\\khodosevich\\matvey\\Writer\\bin\\Debug\\net7.0\\Writer.exe";
            p.StartInfo.UseShellExecute = true;
            p.StartInfo.Arguments = string.Format("{0},{1}", portName, speed);
            p.Start();
